...
struct uprocess_lifecycle {
    ...
    status_code (*on_process_exit)(uprocess *);
    status_code (*fork_process_runtime)(uprocess *); // call this function from the SDK to start the forking runtime autoamta; that will invoke the lifecycle functions
...
status_code exit_subprocess(uprocess *, uprocess_lifecycle *);
